...
class MobileNetWithHist(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(1728, 1024)  # MobileNet output + 히스토그램 크기 수정
...
def initialize_model(num_classes):
    ...
    state_dict = torch.load('WOOTD-Model_V3Large.pth', map_location=device)
    
    # fc1, fc2 레이어를 제외한 가중치 로드
    pretrained_dict = {k: v for k, v in state_dict.items() if "fc1" not in k and "fc2" not in k}
...
user_clothing_paths = {
    ...
    'bottom': [
        ...
        f'{base_path}User_Clothing_List/Bottoms/Bottom6.png',
    ]
}

style_image_path = f'{base_path}Clothings_Combination/test_1.png'
